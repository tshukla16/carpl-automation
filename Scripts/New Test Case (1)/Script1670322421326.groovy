...
WebUI.openBrowser('')
		...
		WebUI.setText(findTestObject('Object Repository/Page_CARPL.ai/input_Login in to_email'), 'automation.testing@carpl.ai')

		WebUI.setEncryptedText(findTestObject('Object Repository/Page_CARPL.ai/input_Login in to_password'), '+47ROO6XJ3vl2Lg59yjZ6Q==')
		...
		WebUI.setText(findTestObject('Object Repository/Page_CARPL.ai/input_Project Name_Name'), 'ermowx130')
