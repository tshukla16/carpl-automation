...
WebUI.click(findTestObject('Object Repository/Page_CARPL.ai/span_Create Workflow'))

WebUI.setText(findTestObject('Object Repository/Page_CARPL.ai/input_Project Name_Name'), 'abd800')
...
WebUI.setText(findTestObject('Page_CARPL.ai/input_Login in to_email'), 'sudo@carpl.ai')
