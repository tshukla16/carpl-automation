...
//WebUI.click(findTestObject('Object Repository/Page_CARPL.ai/div_Delete WorkflowEdit Workflow'))

WebUI.click(findTestObject('Object Repository/Page_CARPL.ai/div_Delete Workflow'))
...
ebUI.click(findTestObject('Object Repository/Page_CARPL.ai/button_LOG IN'))
